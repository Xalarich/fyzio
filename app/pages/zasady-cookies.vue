      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-md border border-zinc-200 p-6 sm:p-10 space-y-6 text-zinc-600 leading-relaxed">
          ...
          <div>
            ...
            <p class="mb-4">
              Svůj souhlas se statistickými cookies můžete kdykoli změnit.
              Aktuální stav: <strong class="text-zinc-800">{{ statusLabel }}</strong>
            </p>
...
const statusLabel = computed(() => {
  if (consent.value === 'granted') return 'povoleno'
  if (consent.value === 'denied') return 'odmítnuto'
