  ...
  <div class="min-h-screen flex flex-col bg-zinc-50">
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto -mt-16">
          <img
            src="/images/blogs/knee.jpg"
            alt="Bolest kolene – syndrom Patellofemorální bolesti"
          ...
          <article class="bg-white rounded-t-lg shadow-xl p-8 sm:p-12 mt-8 prose prose-lg lg:prose-xl max-w-none text-zinc-600">
            ...
            <hr class="my-10 border-zinc-200">
            <div class="flex flex-col md:flex-row gap-5 justify-start items-start">
              <div class="md:max-w-[55%] flex flex-col justify-start items-start gap-4">
                ...
                <ul>
                  <li><strong>Dysbalance čéšky</strong> a její posun směrem laterálním (zevně) odpovídá oslabení vnitřní hlavy stehenního svalu</li>
                  <li><strong>Změny v držení těla a dolních končetin</strong> – zvýšení Q – úhlu, abnormální biomechanika dolní končetiny</li>
                  <li><strong>Zkrácení čtyřhlavého stehenního svalu</strong> – zvětšení přítlaku čéšky</li>
                  <li><strong>Nastavení chodidla</strong> – špatné nastavení chodidla při došlapu – nadměrná pronace a supinace</li>
                  <li><strong>Svalové oslabení</strong>, nedostatečná rovnováha a excentrická kontrola</li>
                </ul>
              ...
              <div class="flex justify-center items-center">
                <img src="/images/blogs/angle-patela.png" alt="Q – úhel pately" class="rounded-lg shadow-2xl max-h-screen md:max-h-[calc(100vh-200px)] w-auto"/>
              </div>
            </div>
            ...
            <ul>
              ...
              <li>Zlepšení osového postavení dolní končetiny</li>
              <li>Zlepšení stability a svalové koordinace</li>
              <li>Zlepšení mobility kotníku a kyčle</li>
              <li>Normalizace svalového tonu</li>
            </ul>
          </article>
        </div>
      </div>
...
useSeoMeta({
  ...
  ogImage: '/images/blogs/knee.jpg',
  articleAuthor: 'Marek Cón',
  articlePublishedTime: '2023-03-20',
  twitterCard: 'summary_large_image',
  twitterTitle: 'Bolest kolene – syndrom Patellofemorální bolesti',
  twitterDescription: 'Syndrom patellofemorální bolesti (PFPS) - běžecké koleno. Bolest na přední straně kolene postihuje přibližně 25 % populace.'
})
</script>
