    ...
    <section class="py-20 bg-white">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
        ...
        <div class="grid gap-12 lg:grid-cols-2 items-center group">
          <div class="overflow-hidden rounded-2xl shadow-xl">
            <img
              ...
              class="w-full h-96 transition-transform duration-700 group-hover:scale-105"
            />
          </div>
          <article class="animate-fade-in-right">
            ...
            <p class="mt-6 text-zinc-700 leading-relaxed text-lg">
        ...
        <div class="grid gap-12 lg:grid-cols-2 items-center group">
          ...
          <div class="overflow-hidden rounded-2xl shadow-xl order-1 lg:order-2">
            <img
        ...
        <div class="bg-gradient-to-r from-zinc-50 to-indigo-50 rounded-3xl p-10 lg:p-14 shadow-sm border border-zinc-200">
          <h2 class="text-3xl lg:text-4xl font-bold text-zinc-900 border-l-4 border-indigo-600 pl-4">Spiraldynamik®</h2>
          <p class="mt-6 text-zinc-700 leading-relaxed text-lg max-w-4xl">
        ...
        <div class="bg-gradient-to-r from-indigo-50 to-zinc-50 rounded-3xl p-10 lg:p-14 shadow-sm border border-zinc-200">
        ...
        <div class="grid gap-12 lg:grid-cols-2 items-center group">
          ...
          <article class="animate-fade-in-right">
            ...
            <p class="mt-4 text-zinc-700 leading-relaxed text-lg">
        ...
        <div class="bg-gradient-to-r from-zinc-50 to-indigo-50 rounded-3xl p-10 lg:p-14 shadow-sm border border-zinc-200">
          ...
          <ul class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
            <li class="flex items-center text-zinc-700 text-lg">
              <span class="w-2 h-2 bg-indigo-500 rounded-full mr-3"></span>
    ...
    <section class="bg-indigo-600 py-16">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="mt-4 text-lg text-indigo-100 max-w-2xl mx-auto">
          Neváhejte nás kontaktovat a společně najdeme řešení vašich potíží.
        </p>
        <div class="mt-8">
          <NuxtLink
            to="/kontakt"
            class="inline-block bg-white hover:bg-zinc-100 text-indigo-700 font-bold py-4 px-10 rounded-lg text-lg transition-all duration-300 ease-in-out transform hover:scale-105 shadow-lg"
          >
            Kontaktujte nás
          </NuxtLink>
        </div>
